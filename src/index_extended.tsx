...
app.get('/', (c) => {
  const html = renderKingdomHTML(`
    ...
    <nav class="navbar">
      <div class="navbar-container">
        ...
        <ul class="nav-links desktop-nav">
          ...
          <li><a href="/diagnostic" class="seal-button" style="padding: 0.6rem 1.5rem; font-size: 0.95rem; margin-right: 1rem;">진단 테스트</a></li>
          <li><a href="/login" class="seal-button" style="padding: 0.6rem 1.5rem; font-size: 0.95rem;" data-i18n="nav.login">Login</a></li>
        </ul>
    ...
    <!-- Cultural Experience Section (NEW) -->
